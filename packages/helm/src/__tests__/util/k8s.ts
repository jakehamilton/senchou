...
export type NodeAffinity = {
	readonly preferredDuringSchedulingIgnoredDuringExecution?: Array<PreferredSchedulingTerm>;
	readonly requiredDuringSchedulingIgnoredDuringExecution?: NodeSelector;
};

export type SerializedNodeAffinity = {
	preferredDuringSchedulingIgnoredDuringExecution?: Array<SerializedPreferredSchedulingTerm>;
...
export type PodAffinity = {
	readonly preferredDuringSchedulingIgnoredDuringExecution?: Array<WeightedPodAffinityTerm>;
	readonly requiredDuringSchedulingIgnoredDuringExecution?: Array<PodAffinityTerm>;
};

export type SerializedPodAffinity = {
	preferredDuringSchedulingIgnoredDuringExecution?: Array<SerializedWeightedPodAffinityTerm>;
	requiredDuringSchedulingIgnoredDuringExecution?: Array<SerializedPodAffinityTerm>;
};
